...
You can create PyTorch Job by defining a PyTorchJob config file. See [distributed MNIST example](https://github.com/kubeflow/pytorch-operator/tree/master/examples/mnist) config file. You may change the config file based on your requirements.
